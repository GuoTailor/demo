 ...
 */
public class SocketServerHttpRequest extends AbstractServerHttpRequest {
    ...
    public interface BodyBuilder extends BaseBuilder<BodyBuilder> {
         ...
         */
        SocketServerHttpRequest body(Publisher<? extends DataBuffer> body);
         ...
         * @return the built request entity
         */
        SocketServerHttpRequest body(String body);
    }
    ...
    private static class DefaultBodyBuilder implements BodyBuilder {
        ...
        @Override
        public SocketServerHttpRequest build() {
            return body(Flux.empty());
        }

        @Override
        public SocketServerHttpRequest body(String body) {
        ...
        @Override
        public SocketServerHttpRequest body(Publisher<? extends DataBuffer> body) {
            applyCookiesIfNecessary();
            return new SocketServerHttpRequest(this.method, getUrlToUse(), this.contextPath,
